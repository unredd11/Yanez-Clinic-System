...
<script src="https://www.paypal.com/sdk/js?client-id=AZV9Vh4PKKTH10qgOs6_D3afEKedbrKpcXCeMb6cVoCWyn5M8Ip1eiX7hwPx1v1ZnBiCreJcoC-f0SHf&currency=USD"></script>
  ...
  if (method === 'online') {
    ...
    paypal.Buttons({
      createOrder: function(data, actions) {
        ...
        if (service === "Laboratory Testing") amount = 20;
        if (service === "Physical Examination") amount = 15;
      ...
      onApprove: function(data, actions) {
        return actions.order.capture().then(function(details) {
          // Save transaction ID into hidden field
